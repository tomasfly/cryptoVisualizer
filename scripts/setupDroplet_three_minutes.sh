...
for i in 159.223.162.134 159.223.162.46 137.184.151.29
do
    ...
    ssh root@$i -i .ssh/digital-ocean-ssh 'cd cryptoVisualizer && bash run.sh "3m" 10 VolumeAnalyzer > output.log &' & 
done